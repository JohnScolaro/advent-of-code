...
def read_input(file_name: str) -> List[str]:
    """
    Reads inputs into a list of strings. The 6 commands are turned into numbers
    because that'll be far easier to deal with later.
    """
    strings = []
...
if __name__ == "__main__":
    strings = read_input('input.txt')
    print("Part A: " + str(part_a(strings)))
    print("Part B: " + str(part_b(strings)))
