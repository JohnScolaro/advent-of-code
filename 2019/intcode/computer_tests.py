...
class TestHelperFunctions(unittest.TestCase):
    def test_get_param_type_immediate(self):
        c = IntCodeComputer()
    ...
    def test_get_param_type_position(self):
        c = IntCodeComputer()
    ...
    def test_get_param_type_large(self):
        c = IntCodeComputer()
    ...
    def test_get_param_type_small(self):
        c = IntCodeComputer()
        c.set_program_code([1])
        param_types = get_parameter_types(c)
        self.assertEqual(param_types, {})

    def test_get_param_type_small_2(self):
        c = IntCodeComputer()
...
class TestComputerDay5(unittest.TestCase):
    def test_part_a_one(self):
        """
        This test should output whatever we input.
        """
        c = IntCodeComputer()
        c.add_opcodes(DEFAULT_OPCODES)
        c.set_program_code([3,0,4,0,99])
        c.specify_input(69)
        retval = c.run()
    ...
    def test_part_a_two(self):
        ...
        c = IntCodeComputer()
        c.add_opcodes(DEFAULT_OPCODES)
        c.set_program_code([1002,4,3,4,33])
        retval = c.run()

    def test_part_a_three(self):
        """
    ...
    def test_part_b_one(self):
        ...
        c = IntCodeComputer()
        c.add_opcodes(DEFAULT_OPCODES)
        c.set_program_code([3,9,8,9,10,9,4,9,99,-1,8])
        c.specify_input(8) # Input == 8
        retval = c.run()
        self.assertEqual(retval, IntCodeComputerError.PROGRAM_TERMINATION)
        ...
        c.add_opcodes(DEFAULT_OPCODES)
        c.set_program_code([3,9,8,9,10,9,4,9,99,-1,8])
        c.specify_input(0) # Input != 8
        retval = c.run()
        self.assertEqual(retval, IntCodeComputerError.PROGRAM_TERMINATION)
        self.assertEqual(c.stdoutput, [0])

    def test_part_b_two(self):
        """
        ...
        c = IntCodeComputer()
        c.add_opcodes(DEFAULT_OPCODES)
        c.set_program_code([3,9,7,9,10,9,4,9,99,-1,8])
        c.specify_input(7) # Input < 8
        retval = c.run()
        self.assertEqual(retval, IntCodeComputerError.PROGRAM_TERMINATION)
        self.assertEqual(c.stdoutput, [1])
    ...
    def test_part_b_three(self):
        ...
        c = IntCodeComputer()
        c.add_opcodes(DEFAULT_OPCODES)
        c.set_program_code([3,3,1108,-1,8,3,4,3,99])
        c.specify_input(8) # Input == 8
        retval = c.run()
        self.assertEqual(retval, IntCodeComputerError.PROGRAM_TERMINATION)
        self.assertEqual(c.stdoutput, [1])
    ...
    def test_part_b_four(self):
        ...
        c = IntCodeComputer()
        c.add_opcodes(DEFAULT_OPCODES)
        c.set_program_code([3,3,1107,-1,8,3,4,3,99])
        c.specify_input(7) # Input < 8
        retval = c.run()
        self.assertEqual(retval, IntCodeComputerError.PROGRAM_TERMINATION)
        self.assertEqual(c.stdoutput, [1])
    ...
    def test_part_b_five(self):
        ...
        c = IntCodeComputer()
        c.add_opcodes(DEFAULT_OPCODES)
        c.set_program_code([3,12,6,12,15,1,13,14,13,4,13,99,-1,0,1,9])
        c.specify_input(0) # Input == 0
        retval = c.run()
        self.assertEqual(retval, IntCodeComputerError.PROGRAM_TERMINATION)
        self.assertEqual(c.stdoutput, [0])
        ...
        c.add_opcodes(DEFAULT_OPCODES)
        c.set_program_code([3,12,6,12,15,1,13,14,13,4,13,99,-1,0,1,9])
        c.specify_input(69) # Input != 0
        retval = c.run()
        self.assertEqual(retval, IntCodeComputerError.PROGRAM_TERMINATION)
        self.assertEqual(c.stdoutput, [1])

    def test_part_b_six(self):
        """
        Here is a jump test that take an input, then output 0 if the input was
        ...
        c = IntCodeComputer()
        c.add_opcodes(DEFAULT_OPCODES)
        c.set_program_code([3,3,1105,-1,9,1101,0,0,12,4,12,99,1])
        c.specify_input(0) # Input == 0
        retval = c.run()
        self.assertEqual(retval, IntCodeComputerError.PROGRAM_TERMINATION)
        self.assertEqual(c.stdoutput, [0])
    ...
    def test_part_b_seven(self):
        """
        Here is a jump test that take an input, then output 0 if the input was
        zero or 1 if the input was non-zero. This one uses immediate mode.
        """
        original_program = [3,21,1008,21,8,20,1005,20,22,107,8,21,20,1006,20,31,1106,0,36,98,0,0,1002,21,125,20,4,20,1105,1,46,104,999,1105,1,46,1101,1000,1,20,4,20,1105,1,46,98,99]

        c = IntCodeComputer()
        c.add_opcodes(DEFAULT_OPCODES)
        c.set_program_code(original_program.copy())
        c.specify_input(7) # Input < 8
        retval = c.run()
        self.assertEqual(retval, IntCodeComputerError.PROGRAM_TERMINATION)
